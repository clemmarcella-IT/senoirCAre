...
<body class="sb-nav-fixed">
    ...
    <main id="main-content">
        <div class="container-fluid px-2 px-md-4">
            <h2 class="mt-4 fw-bold text-success fs-4 fs-md-2">Senior Citizen Profiling</h2>
            
            <div class="card mb-4 border-0 shadow-sm mt-3">
                <div class="card-body">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
                        <span class="text-muted small fw-bold mb-2 mb-md-0 text-center text-md-start">MASTER LIST</span>
    ...
    function printTable() {
        ...
        newWindow.document.write("<html><head><title>Senior Citizen Master List</title>");
        ...
        newWindow.document.write("<div style='text-align:center;border-bottom:2px solid #1F4B2C;padding-bottom:10px;margin-bottom:20px;'><h2>BARANGAY KALAWAG 1</h2><p style='margin:0;'>Senior Citizen Master List</p></div>");
        if (table) {
