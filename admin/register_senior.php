                    ...
                    <form id="seniorForm" action="query_add_senior.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="oscaID" placeholder="Numbers only" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required/>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="file" class="form-control mb-2" name="thumb1" required/>
                                <input type="file" class="form-control mb-2" name="thumb2" required/>
