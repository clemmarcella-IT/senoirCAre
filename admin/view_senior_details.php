                ...
                <div class="card-body p-4">
                    <form id="seniorForm" action="query_add_senior.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                            ...
                            <!-- SEX DROPDOWN (Same as User Register) -->
                            <div class="col-md-4">
                            ...
                            <!-- Row 2 -->
                            <div class="col-md-4"><label class="small fw-bold text-muted">First Name</label><input type="text" class="form-control card shadow border border-1 border-black" name="fname" required/></div>
                            <div class="col-md-4"><label class="small fw-bold text-muted">Middle Name</label><input type="text" class="form-control card shadow border border-1 border-black" name="mi"/></div>
                            <div class="col-md-4"><label class="small fw-bold text-muted">Last Name</label><input type="text" class="form-control card shadow border border-1 border-black" name="lname" required/></div>

                            <!-- Row 3 -->
                            <!-- PUROK DROPDOWN (Same as User Register) -->
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4"><label class="small fw-bold text-muted">Barangay</label><input type="text" class="form-control card shadow border border-1 border-black" name="brgy" value="Kalawag 1" readonly/></div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="file" class="form-control card shadow border border-1 border-black" name="thumb1" required/>
