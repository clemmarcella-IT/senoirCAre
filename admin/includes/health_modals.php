            ...
            <form method="POST" action="query_edit_health_event.php?old_name=<?php echo $hname; ?>&old_date=<?php echo $hdate; ?>">
                <div class="modal-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="hname" class="form-control" value="<?php echo $display['HealthName']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="small fw-bold">Date</label>
                        <input type="date" name="hdate" class="form-control" value="<?php echo $display['HealthDate']; ?>" required>
                    </div>
                    <div class="mb-3">
