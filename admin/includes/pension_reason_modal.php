            ...
            <form action="query_edit_pension_reason.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="new_control" class="form-control" placeholder="Enter number" value="<?php echo $display['ControlNo']; ?>">
                    </div>

                    <!-- Field 2: Absence Reason -->
                    <div class="mb-3">
                        <label class="small fw-bold text-muted">Absence Reason:</label>
                        <input type="text" name="new_reason" class="form-control" placeholder="e.g. Bedridden" value="<?php echo $display['PensionReason']; ?>">
                    </div>
                </div>
