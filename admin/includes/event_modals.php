            ...
            <form method="POST" action="query_edit_event.php?id=<?php echo $eid; ?>">
                <div class="modal-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="ename" class="form-control" value="<?php echo $display['EventName']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="small fw-bold">Date</label>
                        <input type="date" name="edate" class="form-control" value="<?php echo $display['eventDate']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="small fw-bold">Time</label>
                        <input type="time" name="etime" class="form-control" value="<?php echo $display['EventTime']; ?>" required>
                    </div>
                </div>
