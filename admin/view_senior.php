...
<head>
    <meta charset="UTF-8">
    <title>View Senior | <?php echo $id; ?></title>
...
<body class="d-flex bg-light">
        ...
        <div class="card shadow border-0" id="printArea">
            <div class="row g-0">
                ...
                <div class="col-md-8 p-5 bg-white">
                    ...
                    <h5 class="fw-bold border-bottom pb-2 mb-3 mt-5">Documentary Verifications</h5>
                    <div class="row g-3 text-center">
                        <div class="col-6">
                            <label class="small text-muted fw-bold mb-2">3 SIGNATURES</label>
                            <div class="d-flex gap-2">
                                <img src="../uploads/<?php echo $data['SignaturePicture1']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                                <img src="../uploads/<?php echo $data['SignaturePicture2']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                                <img src="../uploads/<?php echo $data['SignaturePicture3']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                            </div>
                        </div>
                        <div class="col-6">
                            <label class="small text-muted fw-bold mb-2">3 THUMBMARKS</label>
                            <div class="d-flex gap-2">
                                <img src="../uploads/<?php echo $data['thumbNailPicture1']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                                <img src="../uploads/<?php echo $data['thumbNailPicture2']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                                <img src="../uploads/<?php echo $data['thumbNailPicture3']; ?>" class="img-thumbnail" style="height: 80px; width: 30%;">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        new QRCode(document.getElementById("qrcode-target"), {
            text: "<?php echo $id; ?>", width: 120, height: 120, colorDark : "#000000"
        });
    </script>
</body>
</html>