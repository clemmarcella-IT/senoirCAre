...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2026 at 11:55 AM
...
(1, '001', '$2y$10$pOqzc.m0/zhvgLJAH5mI3uwyb3nlkm7kCxuqa/fjQXdkYsf546PyG', NULL, NULL);
...
(1, NULL, '2026-04-22', '2026-04-22', 12323.00, NULL, 'claimed', NULL, 'Stopped'),
(2, '055455', '2026-04-22', '2026-04-22', 12323.00, '1143', 'death', NULL, 'Stopped');
...
INSERT INTO `seniors` (`OscaIDNo`, `LastName`, `FirstName`, `MiddleName`, `Sex`, `Purok`, `Barangay`, `Birthday`, `Picture`, `QRCode`, `CitizenStatus`, `SignaturePicture`, `thumbNailPicture`, `GenerateDate`, `ApprovalStatus`) VALUES
('00123', 'ARCELLA', 'CLEM', 'A', 'Male', 'Zone 1', 'Kalawag 1', '1960-09-19', '00123_profile.jpg', '00123', 'active', '00123_sig.jpg', '00123_thumb1.jpg', '2026-04-30 17:10:00', 'approved'),
('055455', 'MARCELLA', 'CLEM', 'A', 'Male', 'Zone 2', 'Kalawag 1', '1926-07-21', '055455_profile.jpg', '055455', 'active', '055455_sig.jpg', '055455_thumb1.jpg', '2026-04-21 12:41:21', 'approved');
...
--
ALTER TABLE `pension`
  MODIFY `PensionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
