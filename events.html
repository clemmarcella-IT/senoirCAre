...
<html lang="en">
<head>
    <meta charset="UTF-8"><title>SENIOR-CARE | Events</title>
            ...
            <div class="col-md-7">
                <div class="card p-4">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Zumba Session - Oct 28</li>
                        <li class="list-group-item">Nutrition Seminar - Nov 02</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-5">
                <div class="card p-4 text-center bg-dark text-white">
                    <h5><i class="fa fa-qrcode"></i> Kiosk Mode: QR Scanner</h5>
                    <div class="qr-scanner-sim"><i class="fa fa-qrcode fa-5x"></i></div>
                </div>
            </div>
        </div>
    </main>
